...
internal fun railSetpointFor(
    ...
    motionPx.leftPullSetpointPx * leftPull +
...
internal fun railPeakXFor(
    ...
    railSetpointFor(leftPull, rightPull, motionPx) -
        railAmplitudeFor(leftPull, rightPull, motionPx)

internal fun railPeakWidthFor(
    leftPull: Float,
    rightPull: Float,
): Float =
    AZ_RAIL_BASE_PEAK_WIDTH +
        AZ_RAIL_LEFT_PULL_PEAK_WIDTH * leftPull -
        AZ_RAIL_RIGHT_PULL_PEAK_WIDTH * rightPull

internal fun railScaleBoostFor(
    leftPull: Float,
    rightPull: Float,
): Float =
    AZ_RAIL_BASE_SCALE_BOOST +
