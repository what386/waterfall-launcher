...
internal data class HomeLayoutMetrics(
    ...
    val searchButtonHorizontalPaddingDp: Float,
    val searchButtonVerticalPaddingDp: Float,
...
internal fun calculateHomeLayoutMetrics(
    ...
    return HomeLayoutMetrics(
        ...
        searchButtonHorizontalPaddingDp = scaleDpByRatio(14f, horizontalScale),
        searchButtonVerticalPaddingDp = scaleDpByRatio(9f, spacingScale),
